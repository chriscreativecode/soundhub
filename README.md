...
<body>
  ...
  <script src="https://unpkg.com/sound-manager-ts@5.7.0/dist/sound-manager-ts.umd.js"></script>
  ...
  <!--
  <script type="module">
    import { SoundManager } from 'https://unpkg.com/sound-manager-ts@5.7.0/dist/sound-manager-ts.es.js';
    // Your ESM code here
  </script>
  -->
